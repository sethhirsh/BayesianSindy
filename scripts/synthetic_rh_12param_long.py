...
with model_sunode:
    ...
    trace = pm.sample(2000, tune=2000, cores=2, random_seed=0, target_accept=0.95, start=start)

    pm.backends.save_trace(trace,'synthetic_rh_12param_long' + '.trace',model_sunode)
