...
with model_sunode:
    trace = pm.sample(1000, tune=1000, cores=10, step_kwargs={'nuts':{'target_accept':0.95}})

    pm.backends.save_trace(trace,'./real/real_reg_minus_5_bern_8_chain_10' + '.trace',model_sunode)
print('done')
