functions {
  real[] dz_dt(real t,       // time
    ...
    real du_dt = theta[1] * u + theta[3] * v + theta[5] * u * v + theta[7] * u * u + theta[9] * v * v - 1e-5 * u * u * u;
    real dv_dt = theta[2] * u + theta[4] * v + theta[6] * u * v + theta[8] + u * u + theta[10] * v * v - 1e-5 * v * v * v;
